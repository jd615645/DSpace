...
<dspace:layout style="submission" locbar="nolink"
               navbar="off"
...
%>
			...
			<img class="img-thumbnail <%= provider %>" src="<%= request.getContextPath() %>/image/submission-lookup-small-<%= provider %>.jpg" />
...
<script type="text/javascript">
    jQuery('#identifier_doi').parent().next().find('.arxiv').css('display', 'none');
</script>
