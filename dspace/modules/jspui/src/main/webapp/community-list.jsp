...
<%
        for (int i = 0; i < communities.length; i++)
        {
            ...
            showCommunity(listType, listNum, communities[i], out, request, ic, collectionMap, subcommunityMap);
        }
%>
    </ul>
...
<script>
    $("div.trigger").click(function(){    
        $(this).parent().find(".media-list").slideToggle();
        if($(this).parent().children(".submedia-list")){
            $(this).parent().children(".submedia-list").slideToggle();
        };
    });
</script>
</dspace:layout>
