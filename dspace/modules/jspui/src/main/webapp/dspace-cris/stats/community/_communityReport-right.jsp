...
<li class="stats-tab<c:if test="${type ne 'community' && type ne 'collection' && type ne 'item' && type ne 'bitstream'}"> stats-tab-current </c:if>">
	<a href="${link}"><fmt:message key="view.stats-community.selectedObject.page.title" /></a>
</li>
<li class="stats-tab<c:if test="${type eq 'community'}"> stats-tab-current </c:if>">
	<a href="${link}&amp;type=community"><fmt:message key="view.stats-community.top.community.page.title" /></a>
</li>
<li class="stats-tab<c:if test="${type eq 'collection'}"> stats-tab-current </c:if>">
	<a href="${link}&amp;type=collection"><fmt:message key="view.stats-community.top.collection.page.title" /></a>
</li>
<li class="stats-tab<c:if test="${type eq 'item'}"> stats-tab-current </c:if>">
	<a href="${link}&amp;type=item"><fmt:message key="view.stats-community.top.item.page.title" /></a>
</li>
<li class="stats-tab<c:if test="${type eq 'bitstream'}"> stats-tab-current </c:if>">
	<a href="${link}&amp;type=bitstream"><fmt:message key="view.stats-community.top.bitstream.page.title" /></a>
</li>
...
<li role="presentation" class="divider"></li>
	...
	<li role="presentation" class="dropdown-header">
		<fmt:message key="view.stats.subscribe.rss.label" />
			...
			<li><a href="${rssLink}daily?uid=${data.object.handle}&amp;type=${data.object.type}" title="Subscribe to RSS statistics update"><img alt="RSS" src="${rssImgLink}" /> Daily</a></li>
			<li><a href="${rssLink}weekly?uid=${data.object.handle}&amp;type=${data.object.type}" title="Subscribe to RSS statistics update"><img alt="RSS" src="${rssImgLink}" /> Weekly</a></li>
			<li><a href="${rssLink}monthly?uid=${data.object.handle}&amp;type=${data.object.type}" title="Subscribe to RSS statistics update"><img alt="RSS" src="${rssImgLink}" /> Monthly</a></li>
