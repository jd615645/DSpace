...
<!--
	j(document).ready(function() {
		...
		document.getElementById("menuName").innerHTML="<fmt:message key="view.${data.jspKey}.${statType}.page.title"><fmt:param>${data.target.simpleName}</fmt:param></fmt:message>";
	});
...
<c:otherwise> 
	<h2 class="titlestats">
		<span class="titlestats"><fmt:message key="view.${data.jspKey}.${statType}.page.title"><fmt:param>${data.target.simpleName}</fmt:param></fmt:message></span>
		<span class="titlestats-condition">${condition}</span>
	</h2>
